...
try {
    ...
    Write-Error "Exception occurred during the addition of the presentation framework."
    throw $_
}
...
$stage = [System.Windows.Window]::new()
$stage.Width = $screen.WorkingArea.Width * 0.75
